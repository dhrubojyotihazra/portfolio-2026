  ...
  return (
    <section className="relative z-10 py-32 px-6 lg:px-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        {/* Right: Text */}
        <div>
          <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.9)]">
            Building intelligent systems out of raw data.
          </h2>

          <div className="text-xl leading-relaxed text-white/70 mb-8 font-light space-y-4">
            <p>
