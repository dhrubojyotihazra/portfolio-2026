...
const defaultItems: SocialItem[] = [
  ...
  { letter: "E", icon: <FaEnvelope />, label: "Email", href: "#" },
...
export default function SocialFlipButton({
  ...
  return (
    <div className={cn("flex items-center justify-center gap-4 p-4", className)}>
      <div
        className="group relative flex items-center justify-center gap-2 rounded-2xl glass-border bg-white/10 p-4 shadow-sm dark:bg-black"
      ...
      >
        ...
        <div className="absolute -inset-[1px] overflow-hidden rounded-2xl pointer-events-none">
          ...
          <motion.div
            className="absolute top-0 left-0 h-[1px] w-full bg-gradient-to-r from-transparent via-white/50 to-transparent dark:via-white/50"
            animate={{ x: ["-100%", "100%"] }}
            transition={{
              duration: 2.5,
              repeat: Infinity,
          ...
          <motion.div
            className="absolute bottom-0 left-0 h-[1px] w-full bg-gradient-to-r from-transparent via-white/50 to-transparent dark:via-white/50"
            animate={{ x: ["100%", "-100%"] }}
            transition={{
              duration: 2.5,
              repeat: Infinity,
