        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {whatIDoItems.map((item, i) => (
            <motion.li 
              ...
              className="group relative min-h-[250px] list-none block"
            >
              <div className="relative h-full rounded-[2.25rem] border-[0.75px] border-white/10 p-2 md:p-3">
                ...
                />
                <div className="relative z-10 flex flex-col justify-center h-full bg-black/10 backdrop-blur-md border border-white/5 rounded-[1.75rem] p-10 shadow-sm transition-all duration-500 overflow-hidden">
